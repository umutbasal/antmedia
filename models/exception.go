...
func (m *Exception) contextValidateCause(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Exception) contextValidateStackTrace(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Exception) contextValidateSuppressed(ctx context.Context, formats strfmt.Registry) error {
