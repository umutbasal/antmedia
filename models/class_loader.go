		...
		if m.DefinedPackages[i] != nil {
			if err := m.DefinedPackages[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("definedPackages" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
	...
	if m.UnnamedModule != nil {
		if err := m.UnnamedModule.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("unnamedModule")
			}
			return err
		}
	}
...
func (m *ClassLoader) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDefinedPackages(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateUnnamedModule(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClassLoader) contextValidateDefinedPackages(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.DefinedPackages); i++ {

		if m.DefinedPackages[i] != nil {
			if err := m.DefinedPackages[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("definedPackages" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("definedPackages" + "." + strconv.Itoa(i))
...
func (m *ClassLoader) contextValidateParent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClassLoader) contextValidateUnnamedModule(ctx context.Context, formats strfmt.Registry) error {

	if m.UnnamedModule != nil {
		if err := m.UnnamedModule.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("unnamedModule")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("unnamedModule")
