...
func (o *GetShutdownStatusOK) Error() string {
	return fmt.Sprintf("[GET /isShutdownProperly][%d] getShutdownStatusOK  %+v", 200, o.Payload)
}
func (o *GetShutdownStatusOK) GetPayload() bool {
	return o.Payload
}

func (o *GetShutdownStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
