...
func (o *SendSupportRequestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSendSupportRequestOK()
...
func (o *SendSupportRequestOK) Error() string {
	return fmt.Sprintf("[POST /v2/support/request][%d] sendSupportRequestOK  %+v", 200, o.Payload)
}
func (o *SendSupportRequestOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *SendSupportRequestOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
