...
func (o *GetNodeListOK) Error() string {
	return fmt.Sprintf("[GET /v2/cluster/nodes/{offset}/{size}][%d] getNodeListOK  %+v", 200, o.Payload)
}
func (o *GetNodeListOK) GetPayload() []*models.ClusterNode {
	return o.Payload
}

func (o *GetNodeListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
