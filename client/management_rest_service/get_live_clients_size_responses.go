...
func (o *GetLiveClientsSizeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetLiveClientsSizeOK()
...
func (o *GetLiveClientsSizeOK) Error() string {
	return fmt.Sprintf("[GET /v2/live-clients-size][%d] getLiveClientsSizeOK  %+v", 200, o.Payload)
}
func (o *GetLiveClientsSizeOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *GetLiveClientsSizeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
