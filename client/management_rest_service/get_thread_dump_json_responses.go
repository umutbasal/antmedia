...
func (o *GetThreadDumpJSONOK) Error() string {
	return fmt.Sprintf("[GET /v2/thread-dump][%d] getThreadDumpJsonOK  %+v", 200, o.Payload)
}
func (o *GetThreadDumpJSONOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *GetThreadDumpJSONOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
