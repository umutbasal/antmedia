...
func (o *IsInClusterModeOK) Error() string {
	return fmt.Sprintf("[GET /v2/cluster-mode-status][%d] isInClusterModeOK  %+v", 200, o.Payload)
}
func (o *IsInClusterModeOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *IsInClusterModeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
