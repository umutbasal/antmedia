...
func (o *GetApplicationInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetApplicationInfoOK()
...
func (o *GetApplicationInfoOK) Error() string {
	return fmt.Sprintf("[GET /v2/applications-info][%d] getApplicationInfoOK  %+v", 200, o.Payload)
}
func (o *GetApplicationInfoOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *GetApplicationInfoOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
