...
func (o *ChangeServerSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewChangeServerSettingsOK()
...
func (o *ChangeServerSettingsOK) Error() string {
	return fmt.Sprintf("[POST /v2/server-settings][%d] changeServerSettingsOK  %+v", 200, o.Payload)
}
func (o *ChangeServerSettingsOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *ChangeServerSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
