...
func (o *IsAuthenticatedRestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewIsAuthenticatedRestOK()
...
func (o *IsAuthenticatedRestOK) Error() string {
	return fmt.Sprintf("[GET /v2/authentication-status][%d] isAuthenticatedRestOK  %+v", 200, o.Payload)
}
func (o *IsAuthenticatedRestOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *IsAuthenticatedRestOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
