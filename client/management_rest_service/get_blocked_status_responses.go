...
func (o *GetBlockedStatusOK) Error() string {
	return fmt.Sprintf("[GET /v2/users/{usermail}/blocked][%d] getBlockedStatusOK  %+v", 200, o.Payload)
}
func (o *GetBlockedStatusOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *GetBlockedStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
