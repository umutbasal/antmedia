...
func (o *GetSystemResourcesInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetSystemResourcesInfoOK()
...
func NewGetSystemResourcesInfoOK() *GetSystemResourcesInfoOK {
	return &GetSystemResourcesInfoOK{}
}
...
func (o *GetSystemResourcesInfoOK) Error() string {
	return fmt.Sprintf("[GET /v2/system-resources][%d] getSystemResourcesInfoOK  %+v", 200, o.Payload)
}
func (o *GetSystemResourcesInfoOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *GetSystemResourcesInfoOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
