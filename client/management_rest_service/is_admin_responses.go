...
func (o *IsAdminOK) Error() string {
	return fmt.Sprintf("[GET /v2/admin-status][%d] isAdminOK  %+v", 200, o.Payload)
}
func (o *IsAdminOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *IsAdminOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
