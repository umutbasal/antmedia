...
func (o *GetLicenceStatusOK) Error() string {
	return fmt.Sprintf("[GET /v2/licence-status][%d] getLicenceStatusOK  %+v", 200, o.Payload)
}
func (o *GetLicenceStatusOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *GetLicenceStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
