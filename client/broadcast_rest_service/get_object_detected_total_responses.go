...
func (o *GetObjectDetectedTotalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetObjectDetectedTotalOK()
...
func NewGetObjectDetectedTotalOK() *GetObjectDetectedTotalOK {
	return &GetObjectDetectedTotalOK{}
}
...
func (o *GetObjectDetectedTotalOK) Error() string {
	return fmt.Sprintf("[GET /v2/broadcasts/{id}/detections/count][%d] getObjectDetectedTotalOK  %+v", 200, o.Payload)
}
func (o *GetObjectDetectedTotalOK) GetPayload() int64 {
	return o.Payload
}

func (o *GetObjectDetectedTotalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
