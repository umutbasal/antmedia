...
func (o *MoveIPCameraOK) Error() string {
	return fmt.Sprintf("[POST /v2/broadcasts/{id}/ip-camera/move][%d] moveIpCameraOK  %+v", 200, o.Payload)
}
func (o *MoveIPCameraOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *MoveIPCameraOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
