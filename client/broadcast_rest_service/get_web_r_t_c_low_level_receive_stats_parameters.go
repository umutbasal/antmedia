...
// NewGetWebRTCLowLevelReceiveStatsParams creates a new GetWebRTCLowLevelReceiveStatsParams object,
...
func NewGetWebRTCLowLevelReceiveStatsParams() *GetWebRTCLowLevelReceiveStatsParams {
	return &GetWebRTCLowLevelReceiveStatsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetWebRTCLowLevelReceiveStatsParamsWithTimeout creates a new GetWebRTCLowLevelReceiveStatsParams object
...
// NewGetWebRTCLowLevelReceiveStatsParamsWithContext creates a new GetWebRTCLowLevelReceiveStatsParams object
...
// NewGetWebRTCLowLevelReceiveStatsParamsWithHTTPClient creates a new GetWebRTCLowLevelReceiveStatsParams object
...
func (o *GetWebRTCLowLevelReceiveStatsParams) WithDefaults() *GetWebRTCLowLevelReceiveStatsParams {
	o.SetDefaults()
	return o
}
...
func (o *GetWebRTCLowLevelReceiveStatsParams) WithTimeout(timeout time.Duration) *GetWebRTCLowLevelReceiveStatsParams {
...
func (o *GetWebRTCLowLevelReceiveStatsParams) WithContext(ctx context.Context) *GetWebRTCLowLevelReceiveStatsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get web r t c low level receive stats params
func (o *GetWebRTCLowLevelReceiveStatsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get web r t c low level receive stats params
func (o *GetWebRTCLowLevelReceiveStatsParams) WithHTTPClient(client *http.Client) *GetWebRTCLowLevelReceiveStatsParams {
...
func (o *GetWebRTCLowLevelReceiveStatsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
