...
func (o *GetStreamInfoOK) Error() string {
	return fmt.Sprintf("[GET /v2/broadcasts/{id}/stream-info][%d] getStreamInfoOK  %+v", 200, o.Payload)
}
func (o *GetStreamInfoOK) GetPayload() []*models.BasicStreamInfo {
	return o.Payload
}

func (o *GetStreamInfoOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
