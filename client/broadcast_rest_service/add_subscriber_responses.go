...
func (o *AddSubscriberOK) Error() string {
	return fmt.Sprintf("[POST /v2/broadcasts/{id}/subscribers][%d] addSubscriberOK  %+v", 200, o.Payload)
}
func (o *AddSubscriberOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *AddSubscriberOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
