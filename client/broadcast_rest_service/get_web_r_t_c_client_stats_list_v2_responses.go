...
func (o *GetWebRTCClientStatsListV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetWebRTCClientStatsListV2OK()
...
func NewGetWebRTCClientStatsListV2OK() *GetWebRTCClientStatsListV2OK {
	return &GetWebRTCClientStatsListV2OK{}
}
...
func (o *GetWebRTCClientStatsListV2OK) Error() string {
	return fmt.Sprintf("[GET /v2/broadcasts/{stream_id}/webrtc-client-stats/{offset}/{size}][%d] getWebRTCClientStatsListV2OK  %+v", 200, o.Payload)
}
func (o *GetWebRTCClientStatsListV2OK) GetPayload() []*models.WebRTCClientStats {
	return o.Payload
}

func (o *GetWebRTCClientStatsListV2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
