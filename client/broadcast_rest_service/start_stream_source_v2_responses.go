...
func (o *StartStreamSourceV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewStartStreamSourceV2OK()
...
func (o *StartStreamSourceV2OK) Error() string {
	return fmt.Sprintf("[POST /v2/broadcasts/{id}/start][%d] startStreamSourceV2OK  %+v", 200, o.Payload)
}
func (o *StartStreamSourceV2OK) GetPayload() *models.Result {
	return o.Payload
}

func (o *StartStreamSourceV2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
