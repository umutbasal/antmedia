...
func (o *AddStreamToTheRoomReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewAddStreamToTheRoomOK()
...
func (o *AddStreamToTheRoomOK) Error() string {
	return fmt.Sprintf("[PUT /v2/broadcasts/conference-rooms/{room_id}/add][%d] addStreamToTheRoomOK  %+v", 200, o.Payload)
}
func (o *AddStreamToTheRoomOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *AddStreamToTheRoomOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
