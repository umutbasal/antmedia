...
func (o *GetWebRTCLowLevelReceiveStatsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetWebRTCLowLevelReceiveStatsOK()
...
func NewGetWebRTCLowLevelReceiveStatsOK() *GetWebRTCLowLevelReceiveStatsOK {
	return &GetWebRTCLowLevelReceiveStatsOK{}
}
...
func (o *GetWebRTCLowLevelReceiveStatsOK) Error() string {
	return fmt.Sprintf("[GET /v2/broadcasts/webrtc-receive-low-level-stats][%d] getWebRTCLowLevelReceiveStatsOK  %+v", 200, o.Payload)
}
func (o *GetWebRTCLowLevelReceiveStatsOK) GetPayload() *models.WebRTCSendStats {
	return o.Payload
}

func (o *GetWebRTCLowLevelReceiveStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
