...
func (o *DeleteStreamFromTheRoomReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteStreamFromTheRoomOK()
...
func NewDeleteStreamFromTheRoomOK() *DeleteStreamFromTheRoomOK {
	return &DeleteStreamFromTheRoomOK{}
}
...
func (o *DeleteStreamFromTheRoomOK) Error() string {
	return fmt.Sprintf("[PUT /v2/broadcasts/conference-rooms/{room_id}/delete][%d] deleteStreamFromTheRoomOK  %+v", 200, o.Payload)
}
func (o *DeleteStreamFromTheRoomOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *DeleteStreamFromTheRoomOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
