...
func (o *AddEndpointV2OK) Error() string {
	return fmt.Sprintf("[POST /v2/broadcasts/{id}/endpoint][%d] addEndpointV2OK  %+v", 200, o.Payload)
}
func (o *AddEndpointV2OK) GetPayload() *models.Result {
	return o.Payload
}

func (o *AddEndpointV2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
