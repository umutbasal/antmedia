...
func (o *GetBroadcastListOK) Error() string {
	return fmt.Sprintf("[GET /v2/broadcasts/list/{offset}/{size}][%d] getBroadcastListOK  %+v", 200, o.Payload)
}
func (o *GetBroadcastListOK) GetPayload() []*models.Broadcast {
	return o.Payload
}

func (o *GetBroadcastListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
