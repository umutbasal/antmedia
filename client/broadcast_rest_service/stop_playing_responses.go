...
func (o *StopPlayingOK) Error() string {
	return fmt.Sprintf("[POST /v2/broadcasts/webrtc-viewers/{webrtc-viewer-id}/stop][%d] stopPlayingOK  %+v", 200, o.Payload)
}
func (o *StopPlayingOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *StopPlayingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
