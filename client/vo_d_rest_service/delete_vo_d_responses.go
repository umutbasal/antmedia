...
func (o *DeleteVoDOK) Error() string {
	return fmt.Sprintf("[DELETE /v2/vods/{id}][%d] deleteVoDOK  %+v", 200, o.Payload)
}
func (o *DeleteVoDOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *DeleteVoDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
