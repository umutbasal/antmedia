...
func (o *ImportVoDsToStalkerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewImportVoDsToStalkerOK()
...
func (o *ImportVoDsToStalkerOK) Error() string {
	return fmt.Sprintf("[POST /v2/vods/import-to-stalker][%d] importVoDsToStalkerOK  %+v", 200, o.Payload)
}
func (o *ImportVoDsToStalkerOK) GetPayload() *models.Result {
	return o.Payload
}

func (o *ImportVoDsToStalkerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
