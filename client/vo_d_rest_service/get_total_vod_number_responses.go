...
func (o *GetTotalVodNumberOK) Error() string {
	return fmt.Sprintf("[GET /v2/vods/count/{search}][%d] getTotalVodNumberOK  %+v", 200, o.Payload)
}
func (o *GetTotalVodNumberOK) GetPayload() int64 {
	return o.Payload
}

func (o *GetTotalVodNumberOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
